...
class MyColors extends ThemeExtension<MyColors>{
  ...
  @override
  ThemeExtension<MyColors> lerp(covariant ThemeExtension<MyColors>? other,
      double t) {
  ...
  static const MyColors dark =
  MyColors(mainColor:ColorsDark.mainColor);

  static const MyColors light =
  MyColors(mainColor:ColorsLight.mainColor);
